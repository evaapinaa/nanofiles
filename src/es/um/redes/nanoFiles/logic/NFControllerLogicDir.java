...
public class NFControllerLogicDir {
	...
	protected boolean doLogin(String directoryHostname, String nickname) {
		...
		try {
			...
			if (result) {
				System.out.println(
						DirMessageOps.OPERATION_LOGIN_OK + ". Session key: " + directoryConnector.getSessionKey());
			} else {
				System.err.println(DirMessageOps.OPERATION_LOGIN_FAILED);
			}
		} catch (IOException e) {
	...
	public boolean doLogout() {
		...
		if (result) {
			System.out.println(DirMessageOps.OPERATION_LOGOUT_OK);
		} else {
			System.err.println(DirMessageOps.OPERATION_LOGOUT_FAILED);
		}
	...
	protected boolean getAndPrintUserList() {
		...
		if (userList != null) {
			System.out.print(DirMessageOps.OPERATION_USER_LIST_OK + ". Registered users: \n");
			...
			System.out.println(DirMessageOps.OPERATION_USER_LIST_FAILED);
		}
	...
	protected boolean getAndPrintFileList() {
		...
		if (fileList != null) {
			...
			System.err.println(DirMessageOps.OPERATION_FILE_LIST_FAILED);
		}
	...
	public boolean registerFileServer(int serverPort) {
		...
		if (result) {
			System.out.println(DirMessageOps.OPERATION_REGISTER_SERVER_PORT_OK);
		} else {
			System.err.println(DirMessageOps.OPERATION_REGISTER_SERVER_PORT_FAILED);
		}
	...
	protected boolean publishLocalFiles() {
		...
		if (result) {
			System.out.println(DirMessageOps.OPERATION_PUBLISH_OK);
		} else {
			System.err.println(DirMessageOps.OPERATION_PUBLISH_FAILED);
		}
		return result;
	}
	...
	private InetSocketAddress lookupServerAddrByUsername(String nickname) {
		...
		if (serverAddr == null) {
			System.err.println("Error: No server found with nickname " + nickname);
		} else {
			System.out.println("Server found with nickname " + nickname + " at " + serverAddr);
		}
	...
	public boolean getAndPrintServersNicknamesSharingThisFile(String fileHashSubstring) {
		...
		/*
		 * result =
		 * directoryConnector.getServersNicknamesSharingThisFile(fileHashSubstring);
		 * 
		 * if (result) { System.out.println(DirMessageOps.OPERATION_SERVERS_LIST_OK); }
		 * else { System.err.println(DirMessageOps.OPERATION_SERVERS_LIST_FAILED); }
		 */
	...
	public boolean unregisterFileServer() {
		...
		result = directoryConnector.unregisterServerPort();

		if (result) {
			System.out.println(DirMessageOps.OPERATION_UNREGISTER_SERVER_PORT_OK);
		} else {
			System.err.println(DirMessageOps.OPERATION_UNREGISTER_SERVER_PORT_FAILED);
		}
